  ...
  return (
    ...
    >
      <div className="flex items-center justify-between text-white py-5">
        <div>
          <h1 className="text-xl font-bold">NaiLottery</h1>
        </div>
        ...
        <div className="hidden lg:flex items-center space-x-3 font-semibold">
          ...
          {wallet ? (
          <button
            className="flex flex-nowrap border py-2 px-4 rounded-full bg-blue-500
          hover:bg-amber-600 cursor-pointer font-semibold text-sm"
          >
      ...
      <div className="pb-10">
        <Link
          href={'/create'}
          className="bg-blue-500 hover:bg-amber-600 text-white rounded-md
